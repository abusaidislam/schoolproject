...
class FlashGroupAController extends Controller
{
    public function index()
    {
     
    $data = FlashExamData::where('cat_id', 1)->orderBy('right_ans', 'desc')->get();
    ...
    return view('admin.flash_group_a_result.index', compact('data'));
    }
