...
class FlashGroupBController extends Controller
{
    public function index()
    {
     
    $data = FlashExamData::where('cat_id', 2)->orderBy('right_ans', 'desc')->get();
    ...
    return view('admin.flash_group_b_result.index', compact('data'));
    }
