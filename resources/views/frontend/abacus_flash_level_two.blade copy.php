            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">History Group-B</h4>
    ...
    <div class="container">
        <footer class="d-flex justify-content-center align-items-center" style="min-height: 100px; margin-top:10px">
            @if ($CompetitioButton->status == 1)
                <button type="button" class="btn btn-primary me-2 FlashHistory2" data-bs-toggle="modal" data-bs-target="#specialHistory" id="modalOpen">History</button>
...
$(document).ready(function() {
    ...
    let FlashLevel2 = @json($FlashLevel2); 
    let specialIndex = 0;
    let decimalDigit = 2;
    let fontSize = 100;
    let countdownTimer;
    ...
    function startGame() {
        ...
        function showNumbers(displayCount) {
            ...
            if (specialIndex < FlashLevel2.length && timeLeft > 0) {
                let currentSettings = FlashLevel2[specialIndex];
                    ...
                    $('#answerInput').off('keypress').on('keypress', function (e) {
                        if (e.which === 13) {
                            ...
                            if (displayCount >= nDisplay) {
                                specialIndex++;
                                if (specialIndex < FlashLevel2.length) {
