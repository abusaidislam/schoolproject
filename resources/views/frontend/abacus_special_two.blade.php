...
@section('title', 'Category A2 Special Category')
@section('content')
    <div class="container-fluid mt-3">
        <div class="info">
            <p class="info-text">{{ $CompetionRegiInfo->student_fullName ?? '' }}<br>
                Category A2 Special Category <br>                                                  
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">History Category A2 Special Category</h4>
...
$(document).ready(function() {
    ...
    let SpacialCategoryA2 = @json($SpacialCategoryA2); // Make sure this is outputting a valid JSON array
    let specialIndex = 0;
    let decimalDigit = 2;
    let fontSize = 40;
    let countdownTimer;
    ...
    function startGame() {
        ...
        function showNumbers(displayCount) {
            if (specialIndex < SpacialCategoryA2.length && currentTime > 0) {
                let currentSettings = SpacialCategoryA2[specialIndex];
                ...
                setTimeout(() => {
                    ...
                    for (let i = 0; i < nRow; i++) {
                        ...
                        // $('#historyContent_special').append('<p> random ' + displayText + '</p>');
                    }

                    // $('#historyContent_special').append('<p>sum = : ' + loopSum + '</p><hr>');
