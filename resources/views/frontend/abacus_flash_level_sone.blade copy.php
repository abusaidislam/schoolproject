...
<body>
    <div class="container-fluid mt-3">
        <div class="timeshow">
            ...
            <!-- Answer input box -->
            <input class="center-input text-center" type="text" id="answerInput" placeholder="Enter Result Here" />
        </div>
    </div>
    <div class="container">
            ...
            if (specialIndex < FlashLevel1.length ) {
                ...
                function displayNumber(i) {
                    ...
                    if (i < nRow) {
                        ...
                        setTimeout(() => {
            $('#data').empty(); // Clear the text
            // Hide the number and set another timeout to show the next number
            setTimeout(() => {
                displayNumber(i + 1); // Show the next number after hiding
            }, 1000); // Wait 1 second before showing the next number
        }, 1000); // Wait 1 second before hiding the number
    } else {
        // When all numbers are displayed, show the answer input box
        $('#answerInput').show().focus();
        $('#inputTimer').show();
        startInputCountdown(); // Start the input countdown timer
    }
                }
