                        ...
                        <form action="{{ url('usermanage') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control" required name="username" placeholder="Full Name">
                                </div>
                                <div class="form-group col-6">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" class="form-control" required name="contactno" placeholder="01XXXXXXXXX">
                                </div>
                                <div class="form-group col-6">
                                    <label>Reference Person</label>
                                    <input type="text" class="form-control" name="referenceper" placeholder="Reference Person">
                                </div>
                                <div class="form-group col-6">
