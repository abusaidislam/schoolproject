...
@section('content')
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Category H Level 7</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card p-1 m-1">
                    <div class="bootstrap-data-table-panel">
                        <div class="table-responsive">
                            <a href="{{ url('category-h-level7/create') }}"class="btn btn-primary mb-3">Add New</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ url('category-h-level7/' . $item->id . '/edit') }}"
                                                        class="btn btn-info">
                                                        <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <form action="{{ url('category-h-level7/' . $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
