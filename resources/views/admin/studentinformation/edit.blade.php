            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-title">
                        <h4 class="p-1">Edit student Information</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form"  style="padding:15px 0px; margin-top:15px; margin-bottom:15px; border:1px solid #eee; background-color:#f0f1ef;">
                            <form action="{{ url('student_info/'. $studentInformation->id) }}" method="POST" enctype="multipart/form-data" style="width: 90%;  margin-left : 5%; margin-top : 2%">
                                @csrf()
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" style="width: 100%" id="student_fullName"  value="{{ $studentInformation->student_fullName }}"
                                        ...
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" style="width: 100%" id="father_name"
                                                    name="father_name" placeholder="* Father's Name" tabindex="5" value="{{ $studentInformation->father_name }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <textarea name="father_occupation" id="father_occupation" class="form-control" style="height: 100px"
                                                    placeholder="Father's Occupation" rows="2"> {{ $studentInformation->father_occupation }}</textarea>
                                        ...
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <input type="number" class="form-control" id="father_contactno" name="father_contactno"
                                                    placeholder="Father's Mobile Number" tabindex="9" required value="{{ $studentInformation->father_contactno }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div>
