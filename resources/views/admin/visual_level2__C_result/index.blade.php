...
@section('content')
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Visual Competition  Special Category A2 Result</h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <table id="example1" class="table table-striped table-bordered table-centre">
                                ...
                                <tbody id="tBody">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                               <span class="bg-warning p-2">Special Category A2</span>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <form action="{{ url('visual-special-a2/' . $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
