...
@section('content')
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Flash Competition Group-B Result</h1>
                </div>
                <div class="col-sm-6">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item update-status" data-status="2" data-id="{{ $item->id }}" href="#">2nd Runner Up</a>
                                                    <a class="dropdown-item update-status" data-status="3" data-id="{{ $item->id }}" href="#">3rd Runner Up</a>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                {{-- <a href="{{ url('flash-group-b-result/' . $item->id . '/edit') }}" class="btn btn-info">
                                                    <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                                                </a> --}}
                                                <form action="{{ url('flash-group-b-result/' . $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
