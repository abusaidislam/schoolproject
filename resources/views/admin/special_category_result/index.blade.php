...
@section('content')
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Visual Competition Result</h1>
                </div>
                <div class="col-sm-6">
                                          ...
                                          $statusLabel = '';
                                            switch ($item->status) {
                                                case 1:
                                                    ...
                                                    break;
                                                case 2:
                                                    $statusLabel = 'First Runner Up';
                                                    break;
                                                case 3:
                                                    $statusLabel = 'Second Runner Up';
                                                    break;
                                                default:
                                                    $statusLabel = 'Merit';
                                                    break;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($item->cat_id == 2)
                                              <span class="bg-secondary p-2">Group-B</span>
                                            @else
                                               <span class="bg-success p-2">Group-C</span>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item update-status" data-status="2" data-id="{{ $item->id }}" href="#">First Runner Up</a>
                                                    <a class="dropdown-item update-status" data-status="3" data-id="{{ $item->id }}" href="#">Second Runner Up</a>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                {{-- <a href="{{ url('special-category-result/' . $item->id . '/edit') }}" class="btn btn-info">
                                                    <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                                                </a> --}}
                                                <form action="{{ url('special-category-result/' . $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
...
<script>
  $(document).ready(function() {
    $('.update-status').click(function(e) {
        ...
        $.ajax({
            url: "{{ route('update.result.status') }}", // Your route for updating the result
            type: 'POST',
            data: {
                _token: "{{ csrf_token() }}",
