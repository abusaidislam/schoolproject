            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-title">
                        <h4 class="p-1">Create Special Category A2</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ url('special-category-a2') }}" method="POST" enctype="multipart/form-data">
                                @csrf()
                                <div class="row">
                                    <div class="form-group col-12">
                                        <label>Number Length</label>
                                        <input type="number" class="form-control" name="num_length" placeholder="Number Length">
                                    </div>
                                    <div class="form-group col-12">
