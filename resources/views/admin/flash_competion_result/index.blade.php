...
@section('content')
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Flash Competition Result</h1>
                </div>
                <div class="col-sm-6">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                {{-- <a href="{{ url('flash-competition-result/' . $item->id . '/edit') }}" class="btn btn-info">
                                                    <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                                                </a> --}}
                                                <form action="{{ url('flash-competition-result/' . $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
