...
@section('content')
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Visual Competition Group-B Result</h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <table id="example1" class="table table-striped table-bordered table-centre">
                                ...
                                <tbody id="tBody">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              <span class="bg-warning p-2">Group-B</span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                {{-- <a href="{{ url('visual-group-b-result/' . $item->id . '/edit') }}" class="btn btn-info">
                                                    <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                                                </a> --}}
                                                <form action="{{ url('visual-group-b-result/' . $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
