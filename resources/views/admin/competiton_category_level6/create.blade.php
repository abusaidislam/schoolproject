            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-title">
                        <h4 class="p-1">Create Competition Category Level 6</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ url('competition-category-level6') }}" method="POST" enctype="multipart/form-data">
                                @csrf()
                                <div class="row">
                                    <div class="form-group col-12">
                                        <label>Number Length1</label>
                                        <input type="number" class="form-control" name="num_length1" placeholder="Number Length1">
                                    </div>
                                    <div class="form-group col-12">
                                        <label>Number Length2</label>
                                        <input type="number" class="form-control" name="num_length2" placeholder="Number Length2">
                                    </div>
                                    <div class="form-group col-12">
